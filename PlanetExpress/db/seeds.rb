...
plane1 = Airplane.create(name: 'air1', row: 6, column: 8)
plane2 = Airplane.create(name: 'air2', row: 5, column: 8)
plane3 = Airplane.create(name: 'air3', row: 6, column: 8)
plane4 = Airplane.create(name: 'air4', row: 6, column: 8)
